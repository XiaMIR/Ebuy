...
public class Verification extends HttpServlet {
	...
	public Color getRandColor(int s, int e) {
		...
		int r = s + random.nextInt(e - s); //随机生成RGB颜色中的r�?

		int g = s + random.nextInt(e - s); //随机生成RGB颜色中的g�?

		int b = s + random.nextInt(e - s); //随机生成RGB颜色中的b�?
	...
	throws ServletException, IOException {
		System.err.println("验证码Servlet被调用");
		...
		for (int i = 0; i < 4; i++) {
			...
			case 1:
				...
				itmp = random.nextInt(26) + 65; // 生成A~Z的字�?
			...
			default:
				...
				itmp = random.nextInt(10) + 48; // 生成0~9的数�?
